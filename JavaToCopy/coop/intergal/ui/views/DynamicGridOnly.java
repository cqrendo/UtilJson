...
@Tag("dynamic-grid-only")
@JsModule("./src/views/generic/layout/dynamic-grid-only.js")
...
public class DynamicGridOnly extends PolymerTemplate<TemplateModel> implements BeforeEnterObserver, HasDynamicTitle{//, PageConfigurator{//, VaadinServiceInitListener  {
